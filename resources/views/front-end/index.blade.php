...
<head>
  ...
  crossorigin="anonymous"></script>
    ...
    <link rel="stylesheet" type="text/css" href="css/front-end/slick.css">
...
<body >  
    ...
    <div class="slider single">
					<div><div class="tm-slider"><img class="tm-sliderimage" src="images/main_slider11.png" alt="To Get Here"> 
					...
					<div><div class="tm-slider"><img class="tm-sliderimage" src="images/main_slider12.png" alt="To Get Here"> 
                        <div class="tm-slidertext">
                        <p class="bold"> Experience</p>
                        <p class="simple">The tranquility </p>
                            <p class="simple">in hotel spa and swimming pool </p></div>
                </div></div>
					<div><div class="tm-slider"><img class="tm-sliderimage" src="images/main_slider13.png" alt="To Get Here"> 
                        <div class="tm-slidertext">
                        <p class="bold"> Experience</p>
                        <p class="simple">The luxorious interiors </p>
                            <p class="simple">in every hotel room </p></div>
                </div></div>
					<div><div class="tm-slider"><img class="tm-sliderimage" src="images/main_slider14.png" alt="To Get Here"> 
                        <div class="tm-slidertext">
     ...
     <section class="slider room flex">
                    ...
                    <div class="tm-rooms">
                       ...
                       <a href="#"> <p class="s">Luxury Suite</p> </a>

                    </div>
                        <div class="tm-rooms">
                        <img  src="images/delux.png">
                            <a href="#"> <p class="s">Deluxe Suite</p></a>

                    </div>
                        <div class="tm-rooms">
                        <img  src="images/premier.png">
                            <a href="#">  <p>Premier Suite</p></a>

                    </div>
                    <div class="tm-rooms">
                        <img  src="images/luxuryroom.png">
                       <a href="#"> <p class="s">Luxury Room</p> </a>

                    </div>
                        <div class="tm-rooms">
                        <img  src="images/deluxroom.png">
                            <a href="#"> <p>Deluxe Room</p></a>

                    </div>
                        <div class="tm-rooms">
                        <img  src="images/premiumroom.png">
                            <a href="#">  <p>Premier Room</p></a>
    ...
    <section class="tm-reviewsection">
        ...
        <p class="b"> Reviews</p>
            ...
            @endfor
                ...
                <div class="tm-rev">
        <p>{{$a->field}}</p>  <br/>
        <p>{{$a->name}} &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp {{$a->job}}</p> </div>
